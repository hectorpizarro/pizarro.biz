  ...
  return (
    <StyledAbout>
      <StyledP>
        ...
        Navigator browser in the 90&apos;s, still a student at the time, I
        wanted to find out what this &apos;internet&apos; was all about. Then
        and there I chose to dedicate my newly born professional life to develop
        web projects.
      </StyledP>
      <StyledP>
